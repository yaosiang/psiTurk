...
# Create a new dashboard manager to control the entire dashboard app
DashboardManager = new Marionette.Application()

# Define regions for the respective views
...
# Launch views after dashboard app initialization
DashboardManager.on "initialize:after", ->
